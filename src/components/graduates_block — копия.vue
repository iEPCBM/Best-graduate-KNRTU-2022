  ...
  <div class="graduates-list-wrapper">
    <div class="alphabet-fl-wr">
      <div class="sort-form-wrapper">
        <p class="sort-frm-label">Сортировать </p>
        <div class="options-selector">
          <ul class="options-wrapper">
            <li class="sort-opt sort-opt-first sort-opt-selected">по фамилии</li>
            <li class="sort-opt sort-opt-last">по институту</li>
          </ul>
        </div>
      </div>
...
.sort-opt-selected::after {
  width: 100%;
  bottom: 0;
  right: 0;
  transition: .5s;
}
.sort-opt-first::after {
  width: 0;
  left: 0;
}
.sort-opt-last::after {
